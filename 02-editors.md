...
>> * Fast
>> * Can be used both as a terminal editor and a graphical editor.
>> * Auto-saves previous version of a file.
>> * Allows advance cut/paste fetures such as rectangular crop, which is very useful for data in tabural formats.
